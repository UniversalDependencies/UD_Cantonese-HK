...
The Cantonese UD treebank was manually annotated by Tak-sum Wong and Herman H. M. Leung at City University of Hong Kong, by finely transcribing a film shooted by students from the School of Creative Media. The data is in Tradiaitonal Chinese.
...
Since there are only 690 tokens, only the test set is provided.
...
Word count:  690
Token count: 690
Dep. relations: 32 of which 7 language specific
POS tags: 13
